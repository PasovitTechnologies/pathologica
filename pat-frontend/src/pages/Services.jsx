...
// Export the services array as a named export
export const services = [
  ...
  {
    category: "Консультация Патолога",
    items: [
      {
        title: "Консультация Патолога",
        price: "15 000 рублей",
      },
    ],
  },
...
const Services = () => {
  return (
    <section
      className="-z-10 relative pt-6 pb-8 lg:pb-13 bg-cover bg-center bg-fixed"
      style={{
          ...
          <div key={index} className="mb-8 md:mb-12">
            ...
            <div className="space-y-4 lg:space-y-0">
              {service.items.map((item, idx) => (
                <div
                  key={idx}
                  className="border shadow-md bg-white shadow-black/40 flex flex-col lg:flex-row lg:items-end"
                >
                  <div
                    className="w-full lg:w-[82%] border-b md:border-b-0 lg:border-r px-4 py-6 md:px-8 md:py-12"
                    style={{
                      boxShadow:
                        "inset 0 -10px 6px -10px rgba(0, 0, 0, 0.3) lg:inset -10px 0 6px -10px rgba(0, 0, 0, 0.5)",
                    }}
                  >
                    ...
                    <p className="text-lg font-bold mt-2 lg:hidden">
                      {item.price}
                    </p>
                    {item.extra && (
                  ...
                  <div className="hidden w-full lg:block lg:w-[18%] px-3 md:px-5 py-4 md:py-10 text-right">
